            ...
            <div class="box-body table-responsive">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td class="text-center" ><a onclick="return confirm('Apakah anda yakin menghapus data atas nama <?php echo $result->nama_lengkap ?> dengan npm <?php echo $result->npm ?>  ?')" href="<?php echo site_url('admin/dashboard/delete/'.$result->id) ?>" title="" class="btn btn-danger btn-sm fa fa-trash-o"></a></td>
                </tr>
                <?php $i++; } ?>
                </tbody>                
              </table>
