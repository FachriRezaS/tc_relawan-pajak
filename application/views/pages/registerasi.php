                 ...
                 <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="telepon" id="telepon" placeholder="08xxxxx" type="text" class="form-control"/>
              ...
              <div class="col-md-6">
                <div class="panel panel-default">
                  <div class="panel-body">
                      ...
                      <div class="form-group">
                            <label>IPK</label>
                            <input name="ipk" id="ipk" placeholder="contoh: 3.5" type="text" class="form-control"/>
                        </div>

                        <div class="form-group">
                            <label>Semester</label>
                            <input name="semester" id="semester" placeholder="isi dengan angka" type="text" class="form-control"/>
                        </div>
